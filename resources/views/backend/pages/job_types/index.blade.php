...
@section('content')
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{__('web.job_types')}}</h3>
                                ...
                                <ul class="m-portlet__nav">
                                    <li class="m-portlet__nav-item">
                                        <a href="#" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air"
                                            onclick="presentModal('{{route('job_types.create')}}', '{{__('web.new_job_type')}}')">
                                            <span>
                                                <i class="la la-plus"></i>
                                                <span>{{__('web.new_job_type')}}</span>
                                            </span>
                                        </a>
                                    </li>
                                </ul>
                                                                ...
                                                                <ul class="m-nav">
                                                                    ...
                                                                    <li class="m-nav__item">
                                                                        <a href="#" class="m-nav__link"
                                                                            onclick="presentModal('{{route('job_types.edit', $job_type->id)}}', '{{__('web.edit_job_type')}}')">
                                                                    ...
                                                                    <li class="m-nav__item">
                                                                        <a href="#" class="m-nav__link"
                                                                            onclick="confirmModal('{{route('job_types.delete', $job_type->id)}}')">
