...
@section('content')
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{__('web.training_types')}}</h3>
                                ...
                                <ul class="m-portlet__nav">
                                    <li class="m-portlet__nav-item">
                                        <a href="#" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air"
                                            onclick="presentModal('{{route('training_types.create')}}', '{{__('web.new_training_type')}}')">
                                            <span>
                                                <i class="la la-plus"></i>
                                                <span>{{__('web.new_training_type')}}</span>
                                            </span>
                                        </a>
                                    </li>
                                </ul>
                                                                ...
                                                                <ul class="m-nav">
                                                                    ...
                                                                    <li class="m-nav__item">
                                                                        <a href="#" class="m-nav__link"
                                                                            onclick="presentModal('{{route('training_types.edit', $training_type->id)}}', '{{__('web.edit_training_type')}}')">
                                                                    ...
                                                                    <li class="m-nav__item">
                                                                        <a href="#" class="m-nav__link"
                                                                            onclick="confirmModal('{{route('training_types.delete', $training_type->id)}}')">
