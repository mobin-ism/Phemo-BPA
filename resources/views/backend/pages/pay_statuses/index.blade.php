...
@section('content')
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{__('web.pay_frequency')}}</h3>
                ...
                <div class="m-portlet m-portlet--mobile">
                            ...
                            <ul class="m-portlet__nav">
                                <li class="m-portlet__nav-item">
                                    <a href="#" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air"
                                        onclick="presentModal('{{route('pay_statuses.create')}}', '{{__('web.new_pay_frequency')}}')">
                                        <span>
                                            <i class="la la-plus"></i>
                                            <span>{{__('web.new_pay_frequency')}}</span>
                                        </span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="m-portlet__body">
                        ...
                        <table class="table table-striped- table-bordered table-hover" id="m_table_1">
                            ...
                            <tbody>
                            @foreach($pay_statuses as $key => $pay_status)
                                <tr>
                                    <td>{{$key + 1}}</td>
                                    <td>{{$pay_status->name}}</td>
                                    @if (Auth::user()->role == "admin")
                                    <td nowrap>
                                                            ...
                                                            <ul class="m-nav">
                                                                ...
                                                                <li class="m-nav__item">
                                                                    <a href="#" class="m-nav__link"
                                                                        onclick="presentModal('{{route('pay_statuses.edit', $pay_status->id)}}', '{{__('web.edit_pay_frequency')}}')">
                                                                ...
                                                                <li class="m-nav__item">
                                                                    <a href="#" class="m-nav__link"
                                                                        onclick="confirmModal('{{route('pay_statuses.delete', $pay_status->id)}}')">
