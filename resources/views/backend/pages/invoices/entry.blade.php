...
<div class="entry-row" id="{{$count}}">
    <div class="row mb-4">
        ...
        <div class="col-lg-2 col-md-2">
            <div class="form-group m-form__group" id="">
                <textarea class="form-control m-input m-input--pill" id="description" name="description[]" rows="1">{{$description}}</textarea>
            </div>
        </div>
        @php
            $uom = '';
        ...
        @php
            $price = '0';
            if (isset($info)) {
                $price = ($type == 'product') ? $info->sales_price : $info->rate;
            }
        @endphp
        <div class="col-lg-1 col-md-1">
            <div class="form-group m-form__group" id="">
