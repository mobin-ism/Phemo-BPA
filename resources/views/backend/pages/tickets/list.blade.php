                                        ...
                                        <ul class="m-nav">
                                            ...
                                            <li class="m-nav__item">
                                                <a href="#" class="m-nav__link"
                                                    onclick="presentModal('{{route('tickets.show', $ticket->id)}}', '{{__('web.ticket_details')}}')">
                                            ...
                                            <li class="m-nav__item">
                                                <a href="#" class="m-nav__link"
                                                    onclick="presentModal('{{route('tickets.edit', $ticket->id)}}', '{{__('web.edit_ticket')}}')">
                                            ...
                                            @endif
                                            @if(is_permitted('ticket_delete'))
                                            <li class="m-nav__item">
                                                <a href="#" class="m-nav__link"
                                                    onclick="confirmModal('{{route('tickets.delete', $ticket->id)}}')">
