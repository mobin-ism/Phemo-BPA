<form method="post" id="modal-form" action="{{route('employees.store_training')}}">
    @csrf
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="form-group m-form__group" id="description-group">
                ...
                <textarea class="form-control m-input m-input--pill" id="description" name="description" rows="3"></textarea>
            </div>
