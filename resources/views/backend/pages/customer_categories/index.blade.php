...
@section('content')
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{__('web.customer_categories')}}</h3>
                                ...
                                <ul class="m-portlet__nav">
                                    <li class="m-portlet__nav-item">
                                        <a href="#" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air"
                                            onclick="presentModal('{{route('customer_categories.create')}}', '{{__('web.new_customer_category')}}')">
                                            <span>
                                                <i class="la la-plus"></i>
                                                <span>{{__('web.new_customer_category')}}</span>
                                            </span>
                                        </a>
                                    </li>
                                </ul>
                                                                ...
                                                                <ul class="m-nav">
                                                                    ...
                                                                    <li class="m-nav__item">
                                                                        <a href="#" class="m-nav__link"
                                                                            onclick="presentModal('{{route('customer_categories.edit', $category->id)}}', '{{__('web.edit_customer_category')}}')">
                                                                    ...
                                                                    <li class="m-nav__item">
                                                                        <a href="#" class="m-nav__link"
                                                                            onclick="confirmModal('{{route('customer_categories.delete', $category->id)}}')">
