...
<form method="post" id="modal-form" action="{{ route('expenses.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row mb-4">
        <div class="col-lg-6">
            ...
            <div class="form-group m-form__group" id="tax_amount-group">
                ...
                <input type="text" class="form-control m-input m-input--pill" id="tax" name="tax_amount" value="0">
            </div>
            <div class="form-group m-form__group" id="tip-group">
                <label for="tip">
                    {{__('web.tip')}}
                </label>
                <input type="text" class="form-control m-input m-input--pill" id="tip" name="tip" value="0">
            </div>
            <div class="form-group m-form__group" id="paid_through-group">
                ...
                <select class="form-control m-bootstrap-select m-bootstrap-select--pill m_selectpicker"
                    ...
                    <option value="petty_cash">{{__('web.petty_cash')}}</option>
                    <option value="cheque">{{__('web.cheque')}}</option>
                    <option value="card">{{__('web.card')}}</option>
                </select>
            </div>
            ...
            <div class="form-group m-form__group" id="">
                ...
                <select class="form-control m-bootstrap-select m-bootstrap-select--pill m_selectpicker"
                    ...
                    <option value="{{$customer->id}}">{{$customer->customer_type == 'company' ? $customer->company_name : $customer->customer_name}}</option>
                    @endforeach
                </select>
            </div>
        </div>
