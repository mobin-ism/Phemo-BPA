...
@section('content')
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{__('web.departments')}}</h3>
                            ...
                            <ul class="m-portlet__nav">
                                <li class="m-portlet__nav-item">
                                    <a href="#" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air"
                                        onclick="presentModal('{{route('departments.create')}}', '{{__('web.new_department')}}')">
                                        <span>
                                            <i class="la la-plus"></i>
                                            <span>{{__('web.new_department')}}</span>
                                        </span>
                                    </a>
                                </li>
                            </ul>
                    ...
                    <div class="m-portlet__body">
                        ...
                        <table class="table table-striped- table-bordered table-hover" id="m_table_1">
                            ...
                            @foreach($departments as $key => $department)
                                @php
                                    $employee_count = \App\Employee::where('department_id', $department->id)->count();
                                @endphp
                                <tr>
                                    <td>{{$key + 1}}</td>
                                                            ...
                                                            <ul class="m-nav">
                                                                ...
                                                                <li class="m-nav__item">
                                                                    <a href="#" class="m-nav__link"
                                                                        onclick="presentModal('{{route('departments.edit', $department->id)}}', '{{__('web.edit_department')}}')">
                                                                ...
                                                                <li class="m-nav__item">
                                                                    <a href="#" class="m-nav__link"
                                                                        onclick="confirmModal('{{route('departments.delete', $department->id)}}')">
