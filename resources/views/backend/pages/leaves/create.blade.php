@if (is_permitted('leave_create') || Auth::user()->role == 'employee')
<form method="post" id="modal-form" action="{{ route('leaves.store') }}">
    @csrf
    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-6">
            <div class="form-group m-form__group" id="reason-group">
                ...
                <textarea class="form-control m-input m-input--pill" id="reason" name="reason" rows="5"></textarea>
            </div>
