...
@section('content')
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{__('web.benefits_and_deductions')}}</h3>
                            ...
                            <ul class="m-portlet__nav">
                                <li class="m-portlet__nav-item">
                                    <a href="#" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air"
                                        onclick="presentModal('{{route('salary_heads.create')}}', '{{__('web.new')}}')">
                                        <span>
                                                            ...
                                                            <ul class="m-nav">
                                                                ...
                                                                <li class="m-nav__item">
                                                                    <a href="#" class="m-nav__link"
                                                                        onclick="presentModal('{{route('salary_heads.edit', $salary_head->id)}}', '{{__('web.edit')}}')">
                                                                ...
                                                                <li class="m-nav__item">
                                                                    <a href="#" class="m-nav__link"
                                                                        onclick="confirmModal('{{route('salary_heads.delete', $salary_head->id)}}')">
