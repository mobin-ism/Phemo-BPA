...
@section('content')
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title m-subheader__title--separator">{{__('web.taxes')}}</h3>
                                ...
                                <ul class="m-portlet__nav">
                                    <li class="m-portlet__nav-item">
                                        <a href="#" class="btn btn-accent m-btn m-btn--custom m-btn--pill m-btn--icon m-btn--air"
                                            onclick="presentModal('{{route('taxes.create')}}', '{{__('web.new_tax_rate')}}')">
                                            <span>
                                                <i class="la la-plus"></i>
                                                <span>{{__('web.new_tax_rate')}}</span>
                                            </span>
                                        </a>
                                    </li>
                                </ul>
                                                                ...
                                                                <ul class="m-nav">
                                                                    ...
                                                                    <li class="m-nav__item">
                                                                        <a href="#" class="m-nav__link"
                                                                            onclick="presentModal('{{route('taxes.edit', $tax->id)}}', '{{__('web.edit_tax_rate')}}')">
                                                                    ...
                                                                    <li class="m-nav__item">
                                                                        <a href="#" class="m-nav__link"
                                                                            onclick="confirmModal('{{route('taxes.delete', $tax->id)}}')">
