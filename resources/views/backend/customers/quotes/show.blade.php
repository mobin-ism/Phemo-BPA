                        ...
                        <div class="m-dropdown__body">
                            <div class="m-dropdown__content">
                                <ul class="m-nav">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="{{route('customer.edit_quote', $quote->id)}}" class="m-nav__link">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="{{route('customer.download_quote', $quote->id)}}" class="m-nav__link">
                                    ...
                                    @if($quote->status == 'active')
                                    <li class="m-nav__item">
                                        <a href="{{route('customer.approve_quote', $quote->id)}}" class="m-nav__link">
                                            <i class="m-nav__link-icon la la-check"></i>
                                            <span class="m-nav__link-text">{{__('web.approve')}}</span>
                                        </a>
                                    </li>
                                    <li class="m-nav__item">
                                        <a href="{{route('customer.reject_quote', $quote->id)}}" class="m-nav__link">
                                            <i class="m-nav__link-icon la la-close"></i>
                                            <span class="m-nav__link-text">{{__('web.reject')}}</span>
                                        </a>
                                    </li>
                                    @endif
                                    {{-- <li class="m-nav__item">
