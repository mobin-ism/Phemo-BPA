...
<head>
    <meta charset="utf-8" />
    <title>Phemo | {{__('web.forgot_password')}}</title>
        ...
        <div class="m-grid__item m-grid__item--fluid  m-grid__item--order-tablet-and-mobile-1  m-login__wrapper">
            ...
            <div class="m-login__body">
                ...
                <div class="m-login__signin">
                    ...
                    <!--begin::Form-->
                    <form class="m-login__form m-form" action="{{ route('password.email') }}" method="post" id="">
                        @csrf
                        <div class="form-group m-form__group @if ($errors->has('email')) has-danger @endif">
                            <input class="form-control m-input" type="email" placeholder="{{__('Enter your email address')}}" 
                    ...
                    <!--end::Form-->
                    <div class="m-login__action">
                        <a href="{{route('login')}}" class="m-link">
